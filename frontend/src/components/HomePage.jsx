...
import PatientNavigation from "./patient/PatientNavigation";
  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-5 left-1/2 z-20 flex -translate-x-1/2 flex-col items-center">
        ...
        {voiceCopy.support ? (
          <p
            className="max-w-[16rem] text-center text-sm font-semibold"
            style={{ color: "#5B6459" }}
          >
            {voiceCopy.support}
          </p>
