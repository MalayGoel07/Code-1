...
export default function Profile({ onNavigate }) {
  ...
  // --------------------------------------------------
  // PATIENT INFORMATION
  // Frontend placeholder data for now.
      ...
      <div className="mt-8 flex flex-col items-center px-6">
        ...
        {voiceState === "not_understood" ? (
          <button
            ...
            className="mt-4 rounded-full px-6 py-3 text-lg font-bold text-white active:scale-95"
            style={{
              background: "#2F6F62",
            }}
          >
      ...
      <main className="mx-auto mt-10 max-w-5xl px-6">
        ...
        >
          ...
          <button
            ...
            className="mx-auto mt-6 flex items-center justify-center gap-2 rounded-full px-7 py-3 text-lg font-bold active:scale-95 focus:outline-none focus-visible:ring-4 focus-visible:ring-[#2F6F62] focus-visible:ring-offset-2"
            style={{
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="mt-1 w-full rounded-xl border-2 bg-white px-3 py-2 text-lg font-bold outline-none focus:ring-4 focus:ring-[#2F6F62]/20"
                      style={{
                        borderColor: "#C9C2B2",
                      }}
                    />
        ...
        <section
          className="mx-auto mt-10 max-w-3xl rounded-3xl p-6 sm:p-8"
          style={{
            background: "#EFEEE6",
            border: "2px solid #E4DCC8",
          }}
        ...
        <section
          className="mx-auto mt-8 max-w-3xl rounded-3xl p-6 text-center"
          style={{
            background: "#F3E7D0",
            border: "2px solid #E4DCC8",
          }}
